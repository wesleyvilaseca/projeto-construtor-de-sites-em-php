...
class TestmonialsController extends Controller
{
    private $repository;
    private $usuario;
    private $route = URL_BASE . 'admin-modules-testmonials/';
    private $module_code = 'modules-testmonials'; //rota no site institucional
    ...
    public function index()
    {
        ...
        $dados['breadcrumb'][]      = ['route' => '#', 'title' => 'Testmonials', 'active' => true];
        $dados['title']             = 'Testimonials';
        $dados["toptitle"]          = 'Testmonials';
    ...
    private function form(string $action = 'save', string $buttonlabel = "Salvar", object $data = null)
    {
        ...
        $inputbanner    = new Combo('banner', $editable);
